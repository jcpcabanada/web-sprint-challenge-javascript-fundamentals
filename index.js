...
function greeting(fName, lName){
  ...
  // console.log('Task',consume(2, 2, add)); // 4
  // console.log('Task',consume(10, 16, multiply)); // 160
  // console.log('Task',consume("Mary", "Poppins", greeting)); // Hello Mary Poppins, nice to meet you!
...
// ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️
// console.log('task',cuboid.volume()); // 100
// console.log('task',cuboid.surfaceArea()); // 130
...
const cuboidTwo = new CuboidMakerTwo(attrs);
